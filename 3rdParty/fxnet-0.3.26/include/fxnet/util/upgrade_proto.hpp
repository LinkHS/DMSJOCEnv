#ifndef FXNET_UTIL_UPGRADE_PROTO_H_
#define FXNET_UTIL_UPGRADE_PROTO_H_
...
bool UpgradeNetAsNeeded( NetParameter* param);
...
bool UpgradeSolverAsNeeded( SolverParameter* param);
...
#endif   // FXNET_UTIL_UPGRADE_PROTO_H_
